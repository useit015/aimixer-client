...
function Fill() {
  ...
  return (
    <div className='Fill'>
      <IonButton className={curBowl.contents.length > 0 && 2 === 3 ? 'Fill__Button-Change-Bowl' : 'Fill__Button-Change-Bowl--hidden'} color={'primary'} onClick={() => dispatch(loginSetMode('mix'))}>Blender</IonButton>
